...
def create_tables():
    ...
    try:
        ...
        # Create employee roles table if it doesn't exist
        cursor.execute("""
        ...
        # Create task_allocations table if it doesn't exist
        cursor.execute("""
...
@app.route('/api/employee-assignments/<employee_id>', methods=['GET'])
